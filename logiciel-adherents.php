...
$faqs = [
    ...
    ['Le logiciel relance-t-il les adhérents pour les cotisations ?', "Oui, automatiquement : les adhérents non à jour reçoivent des relances, et chaque paiement met la fiche à jour en temps réel. Fini le tableur qui se casse."],
  ...
  <div class="pub-container">
    ...
    <div class="lp-hero-grid" style="display:grid;grid-template-columns:1.05fr .95fr;gap:52px;align-items:center;">
      <div>
        ...
        <p class="pub-tagline reveal" style="max-width:560px;">Annuaire intelligent, <strong>rôles personnalisés</strong>, cotisations, espaces membres et communication ciblée. Un fichier adhérents vivant, toujours à jour — fini le tableur qui se casse.</p>
...
<section class="pub-section">
  <div class="pub-container">
    <div class="pub-section-head reveal"><span class="pub-section-eyebrow">Comment ça marche</span><h2 class="pub-h2">Votre <em>logiciel de gestion des adhérents</em> en 4 étapes</h2>
      <p class="pub-section-lead">De la reprise de votre fichier adhérents jusqu'à la fidélisation, chaque étape est pensée pour les bénévoles — sans double-saisie ni tableur qui se casse.</p></div>
    <div class="lp-grid">
      <?php foreach ([
...
<section class="pub-section pub-section-creme">
  <div class="pub-container">
    <div class="pub-section-head reveal"><span class="pub-section-eyebrow">Comparatif</span><h2 class="pub-h2">Tableur, CRM générique ou <em>logiciel adhérents</em> ?</h2>
      <p class="pub-section-lead">Pourquoi un outil pensé pour les associations loi 1901 fait la différence face à un simple tableur Excel ou un CRM générique.</p></div>
      ...
      <table style="width:100%;border-collapse:collapse;font-size:14.5px;min-width:640px;">
        <thead>
          <tr style="background:linear-gradient(135deg,#059669,#047857);color:#fff;">
            ...
            <th style="text-align:center;padding:14px 14px;font-weight:700;">Tableur Excel</th>
        ...
        <tbody>
          <?php foreach ([
            ...
            ['Hébergement en France', 'Selon votre stockage', 'Souvent hors UE', '🇫🇷 Oui'],
