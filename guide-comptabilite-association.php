...
$faqs = [
    ['Une association doit-elle tenir une comptabilité ?', "La loi de 1901 n'impose pas de comptabilité à toutes les associations, mais toute association a intérêt à tenir des comptes clairs pour rendre des comptes à ses membres en assemblée générale — et les statuts l'exigent souvent. Cela devient une obligation légale (comptes annuels complets, voire commissaire aux comptes au-delà de certains seuils réglementaires) dès que l'association perçoit des subventions publiques importantes, reçoit des dons ouvrant droit à reçu fiscal, exerce une activité assujettie à la TVA, emploie des salariés ou est reconnue d'utilité publique."],
...
<section class="pub-section">
  <div class="pub-container">
    <div class="lp-stat reveal" style="background:linear-gradient(135deg,#0f172a,#065f46);">
      ...
      <p>Mettez ce guide en application avec un outil pensé pour les trésoriers bénévoles. Essai gratuit 14 jours, sans carte bancaire, puis à partir de 29,99 €/mois.</p>
