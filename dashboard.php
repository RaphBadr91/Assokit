...
<!-- Les cinq feuilles de style de cette page sont réunies dans un fichier
     statique : 26 Ko qui repartaient à chaque chargement du tableau de
     bord, la page la plus ouverte de l'application. Vérifié avant de les
     regrouper : aucun sélecteur en commun avec le CSS des blocs inclus
     plus bas, l'ordre de la cascade ne change pas.
     (Pas de balise ouvrante écrite en toutes lettres dans ce commentaire :
      un outil qui cherche les feuilles de style la compterait pour vraie
      et lirait la page de travers.) -->
<link rel="stylesheet" href="/assets/dashboard.css?v=<?= @filemtime(__DIR__ . '/assets/dashboard.css') ?>">
