...
<div class="sa-app">
  <aside class="sa-sidebar" id="sa-sidebar">
    ...
    <nav class="sa-nav">
      ...
      <?php if ($is_founder): ?>
      <?php
        $founder_pages = ['fondateur-pilotage', 'fondateur-pricing', 'fondateur-plans', 'fondateur-create-organization', 'fondateur-domains', 'fondateur-stripe-config', 'admin-blog', 'fondateur-activity', 'fondateur-cartes', 'fondateur-campagnes', 'fondateur-listes'];
